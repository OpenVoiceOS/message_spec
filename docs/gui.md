...
| `mycroft.gui.connected`     | "gui_id": str, "framework": str | DEPRECATED: old gui clients connected to wrong bus                                     |                                  | self.handle_client_connected    |
...
| `mycroft.gui.port`               | "port": int, "gui_id": str | DEPRECATED: tell old gui clients what port the real gui websocket is | `mycroft.gui.connected`                                |
